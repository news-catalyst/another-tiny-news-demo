...
module.exports = {
  siteMetadata: {
    shortName: `another tinynewsco`,
    title: `the other tiny news collective`,
    siteUrl: `https://anothertinynewsco.org/`,
    description: `another local news initiative`,
    subscribe: {
      title: `Subscribe`,
      subtitle: `Get the latest news about the other tiny news collective in your inbox.`,
    },
    footerTitle: `anothertinynewsco.org`,
    ...
    [
      ...
      `gatsby-plugin-netlify-cache`,
      {
        ...
        options: {
          ...
          canonicalBaseUrl: 'http://anothertinynewsco.org/',
          components: ['amp-form'],
          excludedPaths: ['/404*', '/'],
          pathIdentifier: '/amp/',
